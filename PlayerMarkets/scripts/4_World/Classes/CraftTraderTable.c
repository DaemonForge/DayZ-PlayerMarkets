modded class PluginRecipesManager 
{
 	...
 	override void RegisterRecipies()
	{
		...
		RegisterRecipe(new CraftTraderTableKit);
		RegisterRecipe(new CraftTraderStallKit);
		RegisterRecipe(new CraftTraderStallV2Kit);
    }
};


class CraftTraderTableKit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Market Table Kit";
		...
		//result1
		AddResult("PM_MarketTableKit");//add results here
...
class CraftTraderStallKit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Market Stall Kit";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("PM_MarketKit");//add results here
...
class CraftTraderStallV2Kit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Large Market Stall Kit";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		m_MinQuantityIngredient[1] = 4;//-1 = disable check
		m_MaxQuantityIngredient[1] = -1;//-1 = disable check
		//----------------------------------------------------------------------------------------------------------------------
		...
		//result1
		AddResult("PM_MarketV2Kit");//add results here
